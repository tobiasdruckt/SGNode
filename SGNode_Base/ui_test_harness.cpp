...
static void handleCommand(char* line) {
  ...
  if (strcmp(line, "help") == 0) {
    printOK("commands=help,build_info,screen,dump_ui,tap,press,release,swipe,tap_label,type,key,wait,expect_screen,expect_text,expect_not_text,expect_value,expect_state,set_mock_sg,set_mock_temp,set_mock_time,run_analyzer,run_state_machine,run_eta,run_recommendations,create_test_batch,delete_test_batch,mark_test_batch_completed,battery_stats,batch_diagnostics,float_stats,action_status,action_done,action_skip,run_action_button_tests,selftest,prepare_manage_brew_complete,open_manage_brew_complete_dialog,confirm_manage_brew_complete,run_input_validation_tests,run_sensor_edge_tests,run_state_logic_tests,run_ui_safety_tests,run_batch_restore_tests,run_fallback_log_tests,run_completed_batch_tests,run_manage_brew_ui_tests,run_ui_regression_tests");
    return;
  }
  ...
  if (strcmp(line, "release") == 0) {
    if (uiTestRelease()) printOK("released");
